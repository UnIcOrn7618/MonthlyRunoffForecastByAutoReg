...
writetable(decompositions, [save_path,mother_wavelet,'-lev',num2str(lev),'/WD_FULL.csv'])
...
% save the decomposition results and the original data
decompositions = array2table(signals, 'VariableNames', columns);
writetable(decompositions, [save_path,mother_wavelet,'-lev',num2str(lev),'/WD_TRAIN.csv'])
