...
def plot_objective(result, levels=10, n_points=40, n_samples=250, size=2,figsize=(7.48,7.48),
    ...
    * `figsize` [tuple float, default=(7.48.7.48)]
        Width, Height (in inches) of each facet.
...
def plot_evaluations(result, bins=20,figsize=(7.48,7.48), dimensions=None):
    ...
    * `ax`: [`Axes`]:
    ...
    fig, ax = plt.subplots(space.n_dims, space.n_dims,figsize=(7.48, 7.48))
