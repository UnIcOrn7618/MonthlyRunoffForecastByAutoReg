...
h_dwt = pd.read_csv(
    root_path+"/Huaxian_dwt/projects/esvr/db10-2/one_step_1_month_forecast_traindev_test/Huaxian_dwt_esvr_one_step_1_month_forecast_traindev_test.csv")
x_eemd = pd.read_csv(
...
x_dwt = pd.read_csv(
    root_path+"/Xianyang_dwt/projects/esvr/db10-2/one_step_1_month_forecast_traindev_test/Xianyang_dwt_esvr_one_step_1_month_forecast_traindev_test.csv")
z_eemd = pd.read_csv(
...
z_dwt = pd.read_csv(
    root_path+"/Zhangjiashan_dwt/projects/esvr/db10-2/one_step_1_month_forecast_traindev_test/Zhangjiashan_dwt_esvr_one_step_1_month_forecast_traindev_test.csv")
...
h_dwt_dev_y, h_dwt_dev_pred, h_dwt_test_y, h_test_pred, h_dwt_metrics = read_two_stage_traindev_test(
...
x_dwt_dev_y, x_dwt_dev_pred, x_dwt_test_y, x_test_pred, x_dwt_metrics = read_two_stage_traindev_test(
...
z_dwt_dev_y, z_dwt_dev_pred, z_dwt_test_y, z_test_pred, z_dwt_metrics = read_two_stage_traindev_test(
...
all_data1 = [
    ...
    [h_dwt["dev_r2"][0], x_dwt["dev_r2"][0], z_dwt["dev_r2"][0]],
    [h_dwt["test_r2"][0], x_dwt["test_r2"][0], z_dwt["test_r2"][0]],
]
...
all_data2 = [
    ...
    [h_dwt_metrics["dev_nse"], x_dwt_metrics["dev_nse"], z_dwt_metrics["dev_nse"]],
    [h_dwt_metrics["test_nse"], x_dwt_metrics["test_nse"], z_dwt_metrics["test_nse"]],
]
...
all_data1 = [
    ...
    [h_dwt["dev_nrmse"][0], x_dwt["dev_nrmse"][0], z_dwt["dev_nrmse"][0]],
    [h_dwt["test_nrmse"][0], x_dwt["test_nrmse"][0], z_dwt["test_nrmse"][0]],
]
...
all_data2 = [
    ...
    [h_dwt_metrics["dev_nrmse"], x_dwt_metrics["dev_nrmse"], z_dwt_metrics["dev_nrmse"]],
    [h_dwt_metrics["test_nrmse"], x_dwt_metrics["test_nrmse"], z_dwt_metrics["test_nrmse"]],
]
