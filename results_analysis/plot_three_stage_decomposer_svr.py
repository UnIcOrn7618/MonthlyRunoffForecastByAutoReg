...
ax1.plot(huaxian_wd['pred'],':',label='DWT-SVR-SUM',lw=1.5,zorder=2)
...
records_list=[huaxian_vmd['orig'].values,huaxian_wd['orig'].values,huaxian_ssa['orig'].values,huaxian_eemd['orig'].values,h_records]
predictions_list=[huaxian_vmd['pred'].values,huaxian_wd['pred'].values,huaxian_ssa['pred'].values,huaxian_eemd['pred'].values,h_predictions]
...
ax3.plot(xianyang_wd['pred'],':',label='DWT-SVR',lw=1.5,zorder=2)
...
records_list=[xianyang_vmd['orig'].values,xianyang_wd['orig'].values,xianyang_ssa['orig'].values,xianyang_eemd['orig'].values,x_records]
predictions_list=[xianyang_vmd['pred'].values,xianyang_wd['pred'].values,xianyang_ssa['pred'].values,xianyang_eemd['pred'].values,x_predictions]
xx,linear_list,xymin,xymax=compute_list_linear_fit(
    records_list=records_list,
    predictions_list=predictions_list,
)
...
ax5.plot(zhangjiashan_wd['pred'],':',label='DWT-SVR-SUM',lw=1.5,zorder=2)
...
records_list=[zhangjiashan_vmd['orig'].values,zhangjiashan_wd['orig'].values,zhangjiashan_ssa['orig'].values,zhangjiashan_eemd['orig'].values,z_records]
predictions_list=[zhangjiashan_vmd['pred'].values,zhangjiashan_wd['pred'].values,zhangjiashan_ssa['pred'].values,zhangjiashan_eemd['pred'].values,z_predictions]
xx,linear_list,xymin,xymax=compute_list_linear_fit(
    records_list=records_list,
    predictions_list=predictions_list,
)
